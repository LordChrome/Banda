...
def predictive_analysis(teamA_values, teamB_values, last6matcheshome, last6matchesaway):
 total = 0
 ...
 lists = list_generator_backup.list_creator(last6matcheshome, last6matchesaway)
 teamA50 = lists[0]
 teamA30 = lists[1]
 teamA20 = lists[2]
 teamB50 = lists[3]
 ...
 return (Probability_teamA_win/100000), (Probability_teamA_draw/100000), (Probability_teamB_win/100000), (Probability_teamB_draw/100000)
