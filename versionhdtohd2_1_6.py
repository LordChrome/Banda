...
def predictive_analysis(teamA_values, teamB_values, teamA_probability, teamB_probability):
 ...
 lists = list_generator_backup.list_creator(teamA_probability, teamB_probability)
 teamA50 = lists[0]
 teamA30 = lists[1]
 teamA20 = lists[2]
 teamB50 = lists[3]
 ...
 while(totalA <= 1000000):
    if totalA == total_interval:
        ...
        choices = copy.deepcopy(list_generator_interval())
        lists = copy.deepcopy(list_generator_backup.list_creator(teamA_probability, teamB_probability))
        teamA50 = lists[0]
        teamA30 = lists[1]
        teamA20 = lists[2]
        teamB50 = lists[3]
